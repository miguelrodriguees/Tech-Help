...
<section className="rent-v2" id="ferramentas" aria-labelledby="aluguel-title"><div className="th-inner rent-layout">
 ...
 <p className="rent-explanation">Escolha a ferramenta ou kit, combine o período e a retirada. Ao terminar, devolva o equipamento.</p>
 ...
 <small>Catálogo e reservas em preparação.</small></div>
