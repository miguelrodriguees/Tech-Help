...
export default function ReceivedOffers({idPedido,onLogin}:{idPedido:number;onLogin:()=>void}) {
 ...
 return <div className="th-received-offers">
  ...
  {loading?<p role="status">Carregando…</p>:<>
   ...
   {service&&<ServiceCard service={service} role="cliente" onLogin={onLogin} onChange={updated=>setServices(current=>current.map(s=>s.idServico===updated.idServico?updated:s))}/>}
